...
public class Contact {
	...
	public Contact(String nom, String prenom, int age, String phone, String address, String codePostal, String ville, String pays, double note) {
	...
	/*public String toString() {
		return  nom +" "+ prenom +" "+ age +" "+ phone +" "+address+" "+ codePostal +" "+ ville + " "+ pays + " " + note;
	}*/
