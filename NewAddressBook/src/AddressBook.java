	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getActionCommand() == "Add New!") {
			...
			if (txtFirstName.getText().equals("") && txtLastName.getText().equals("")
				...
				contact.setDetails(txtFirstName.getText(), txtLastName.getText(), txtNickname.getText(),
			...
			try {
				...
				if (index == -1) {
					...
					JOptionPane.showMessageDialog(newFrame, "Select a Contact first to delete it.",
					...
					int n = JOptionPane.showConfirmDialog(newFrame,
							"Are you sure you want to delete the selected Contact?", "Are you sure?",
			...
			if (flag) {
				...
				JOptionPane.showMessageDialog(newFrame, "No Such Contact Found!", "Search Result!",
						JOptionPane.INFORMATION_MESSAGE);
			}
